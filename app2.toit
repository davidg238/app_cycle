...
main:
    ...
    sans_big_context := tft.context --landscape --color=(get_rgb 0x00 0xff 0x00) --font=sans_big

    clear_screen tft

    tft.text sans_big_context 20 60 "App 2"
    tft.draw

    sleep --ms=2000
    close tft driver device bus
    print "... end app2"
    pubsub.publish "device:app3" "from_app2"
